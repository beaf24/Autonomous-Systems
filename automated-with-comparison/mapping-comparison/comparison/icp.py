...
def icp_trans(reference_points, points, max_iterations=100, distance_threshold=0.3, convergence_translation_threshold=1e-3,
    ...
    for iter_num in range(max_iterations):
        ...
        # update transformation history
        transformation_history.append(np.hstack((np.array([[closest_translation_x], [closest_translation_y]]))))
